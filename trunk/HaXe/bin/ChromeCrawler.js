...
if(!crawler.rendering.three) crawler.rendering.three = {}
crawler.rendering.three.ThreeRenderer = function(c) { if( c === $_ ) return; {
	$s.push("crawler.rendering.three.ThreeRenderer::new");
	var $spos = $s.length;
	this.crawler = c;
	$s.pop();
}}
crawler.rendering.three.ThreeRenderer.__name__ = ["crawler","rendering","three","ThreeRenderer"];
crawler.rendering.three.ThreeRenderer.prototype.crawler = null;
crawler.rendering.three.ThreeRenderer.prototype.camera = null;
crawler.rendering.three.ThreeRenderer.prototype.scene = null;
crawler.rendering.three.ThreeRenderer.prototype.renderer = null;
crawler.rendering.three.ThreeRenderer.prototype.width = null;
crawler.rendering.three.ThreeRenderer.prototype.height = null;
crawler.rendering.three.ThreeRenderer.prototype._updateTimer = null;
crawler.rendering.three.ThreeRenderer.prototype._nodes = null;
crawler.rendering.three.ThreeRenderer.prototype.beginRendering = function(window) {
	$s.push("crawler.rendering.three.ThreeRenderer::beginRendering");
	var $spos = $s.length;
	if(window == null) {
		{
			$s.pop();
	...
	new $(js.Lib.window).resize($closure(this,"onResize"));
	this.width = js.Lib.window.innerWidth;
	this.height = js.Lib.window.innerHeight;
	this.camera = new three.Camera(60,this.width / this.height,1,10000);
	...
	this.makeNodes();
	this._updateTimer = new haxe.Timer(32);
	this._updateTimer.run = $closure(this,"render");
	$s.pop();
}
crawler.rendering.three.ThreeRenderer.prototype.onResize = function() {
	$s.push("crawler.rendering.three.ThreeRenderer::onResize");
	var $spos = $s.length;
	this.width = js.Lib.window.innerWidth;
	this.height = js.Lib.window.innerHeight;
	this.renderer.setSize(this.width,this.height);
...
crawler.rendering.three.ThreeRenderer.prototype.makeNodes = function() {
	$s.push("crawler.rendering.three.ThreeRenderer::makeNodes");
	var $spos = $s.length;
	var tex = THREE.ImageUtils.loadTexture("images/icon32.png");
	this._nodes = new Array();
	{
		var _g = 0;
		while(_g < 2000) {
			var i = _g++;
			var n = new crawler.rendering.three.ThreeNode(this);
			n.init(this.scene,tex);
			this.scene.addObject(n.sprite);
			this._nodes.push(n);
		}
	}
	$s.pop();
}
crawler.rendering.three.ThreeRenderer.prototype.render = function() {
	$s.push("crawler.rendering.three.ThreeRenderer::render");
	var $spos = $s.length;
	{
...
crawler.rendering.three.ThreeRenderer.prototype.__class__ = crawler.rendering.three.ThreeRenderer;
if(!crawler.rendering.raphael) crawler.rendering.raphael = {}
crawler.rendering.raphael.Node = function(paper) { if( paper === $_ ) return; {
	$s.push("crawler.rendering.raphael.Node::new");
	var $spos = $s.length;
	this._paper = paper;
	this.init();
	$s.pop();
}}
crawler.rendering.raphael.Node.__name__ = ["crawler","rendering","raphael","Node"];
crawler.rendering.raphael.Node.prototype.x = null;
crawler.rendering.raphael.Node.prototype.y = null;
crawler.rendering.raphael.Node.prototype._x = null;
crawler.rendering.raphael.Node.prototype._y = null;
crawler.rendering.raphael.Node.prototype._velX = null;
crawler.rendering.raphael.Node.prototype._velY = null;
crawler.rendering.raphael.Node.prototype._paper = null;
crawler.rendering.raphael.Node.prototype._graphic = null;
crawler.rendering.raphael.Node.prototype.update = function() {
	$s.push("crawler.rendering.raphael.Node::update");
	var $spos = $s.length;
	{
		var _g = this;
...
crawler.rendering.raphael.Node.prototype.init = function() {
	$s.push("crawler.rendering.raphael.Node::init");
	var $spos = $s.length;
...
crawler.rendering.raphael.Node.prototype.getX = function() {
	$s.push("crawler.rendering.raphael.Node::getX");
	var $spos = $s.length;
	{
		var $tmp = this._x;
		$s.pop();
...
crawler.rendering.raphael.Node.prototype.getY = function() {
	$s.push("crawler.rendering.raphael.Node::getY");
	var $spos = $s.length;
	{
		var $tmp = this._y;
		$s.pop();
...
crawler.rendering.raphael.Node.prototype.setX = function(v) {
	$s.push("crawler.rendering.raphael.Node::setX");
	var $spos = $s.length;
...
crawler.rendering.raphael.Node.prototype.setY = function(v) {
	$s.push("crawler.rendering.raphael.Node::setY");
	var $spos = $s.length;
...
crawler.rendering.raphael.Node.prototype.__class__ = crawler.rendering.raphael.Node;
crawler.CrawlerTabMain = function(p) { if( p === $_ ) return; {
	...
	this._renderer = new crawler.rendering.three.ThreeRenderer(this._crawler);
	this._renderer.beginRendering(new $("#renderTarget")[0]);
	$s.pop();
}}
...
crawler.rendering.three.ThreeNode = function(three) { if( three === $_ ) return; {
	$s.push("crawler.rendering.three.ThreeNode::new");
	var $spos = $s.length;
	this._three = three;
	$s.pop();
}}
crawler.rendering.three.ThreeNode.__name__ = ["crawler","rendering","three","ThreeNode"];
crawler.rendering.three.ThreeNode.prototype.x = null;
crawler.rendering.three.ThreeNode.prototype.y = null;
crawler.rendering.three.ThreeNode.prototype.sprite = null;
crawler.rendering.three.ThreeNode.prototype._x = null;
crawler.rendering.three.ThreeNode.prototype._y = null;
crawler.rendering.three.ThreeNode.prototype._velX = null;
crawler.rendering.three.ThreeNode.prototype._velY = null;
crawler.rendering.three.ThreeNode.prototype._scene = null;
crawler.rendering.three.ThreeNode.prototype._three = null;
crawler.rendering.three.ThreeNode.prototype.update = function() {
	$s.push("crawler.rendering.three.ThreeNode::update");
	var $spos = $s.length;
	{
		var _g = this;
		_g.setX(_g._x + this._velX);
	...
	if(this._x > this._three.width) {
		this._velX = -this._velX;
		this.setX(this._three.width);
	}
	if(this._y > this._three.height) {
		this._velY = -this._velY;
		this.setY(this._three.height);
	}
	if(this._x < 0) {
		this._velX = -this._velX;
		{
...
crawler.rendering.three.ThreeNode.prototype.init = function(scene,tex) {
	$s.push("crawler.rendering.three.ThreeNode::init");
	var $spos = $s.length;
	this.sprite = new three.Sprite({ map : tex, useScreenCoordinates : true, affectedByDistance : false});
	this.setX(Math.random() * this._three.width);
	this.setY(Math.random() * this._three.height);
	this._velX = -5 + Math.random() * 10;
	this._velY = -5 + Math.random() * 10;
	$s.pop();
}
crawler.rendering.three.ThreeNode.prototype.getX = function() {
	$s.push("crawler.rendering.three.ThreeNode::getX");
	var $spos = $s.length;
	{
		var $tmp = this._x;
		$s.pop();
...
crawler.rendering.three.ThreeNode.prototype.getY = function() {
	$s.push("crawler.rendering.three.ThreeNode::getY");
	var $spos = $s.length;
	{
		var $tmp = this._y;
		$s.pop();
...
crawler.rendering.three.ThreeNode.prototype.setX = function(v) {
	$s.push("crawler.rendering.three.ThreeNode::setX");
	var $spos = $s.length;
	this.sprite.position.x = v;
	{
		var $tmp = this._x = v;
		$s.pop();
		return $tmp;
...
crawler.rendering.three.ThreeNode.prototype.setY = function(v) {
	$s.push("crawler.rendering.three.ThreeNode::setY");
	var $spos = $s.length;
	this.sprite.position.y = v;
	{
		var $tmp = this._y = v;
		$s.pop();
		return $tmp;
...
crawler.rendering.three.ThreeNode.prototype.__class__ = crawler.rendering.three.ThreeNode;
...
three.RequestAnimationFrame = function() { }
three.RequestAnimationFrame.__name__ = ["three","RequestAnimationFrame"];
three.RequestAnimationFrame.request = function(method) {
	$s.push("three.RequestAnimationFrame::request");
	var $spos = $s.length;
	var requestAnimationFrame = window.requestAnimationFrame || (window.webkitRequestAnimationFrame || (window.mozRequestAnimationFrame || (window.oRequestAnimationFrame || window.msRequestAnimationFrame)));
	if(requestAnimationFrame == null) {
		requestAnimationFrame = function(method1,element) {
			$s.push("three.RequestAnimationFrame::request@16");
			var $spos = $s.length;
...
three.RequestAnimationFrame.prototype.__class__ = three.RequestAnimationFrame;
crawler.rendering.raphael.RaphaelRenderer = function(crawler) { if( crawler === $_ ) return; {
	$s.push("crawler.rendering.raphael.RaphaelRenderer::new");
	var $spos = $s.length;
	this._crawler = crawler;
	this._paper = new Raphael(0,0,"100%","100%");
	$s.pop();
}}
crawler.rendering.raphael.RaphaelRenderer.__name__ = ["crawler","rendering","raphael","RaphaelRenderer"];
crawler.rendering.raphael.RaphaelRenderer.prototype._crawler = null;
crawler.rendering.raphael.RaphaelRenderer.prototype._paper = null;
crawler.rendering.raphael.RaphaelRenderer.prototype._updateTimer = null;
crawler.rendering.raphael.RaphaelRenderer.prototype._nodes = null;
crawler.rendering.raphael.RaphaelRenderer.prototype.beginRendering = function() {
	$s.push("crawler.rendering.raphael.RaphaelRenderer::beginRendering");
	var $spos = $s.length;
	...
	this._nodes = new Array();
	{
		...
		while(_g < 300) {
			var i = _g++;
			var n = new crawler.rendering.raphael.Node(this._paper);
			this._nodes.push(n);
		}
	}
	$s.pop();
}
crawler.rendering.raphael.RaphaelRenderer.prototype.onUpdate = function() {
	$s.push("crawler.rendering.raphael.RaphaelRenderer::onUpdate");
	var $spos = $s.length;
	var _g1 = 0, _g = this._nodes.length;
	while(_g1 < _g) {
		var i = _g1++;
...
crawler.rendering.raphael.RaphaelRenderer.prototype.__class__ = crawler.rendering.raphael.RaphaelRenderer;
...
crawler.rendering.raphael.Node.colours = ["754C24","C7B299","F26C4F","3BB878","736357","605CA8","A67C52"];
...
crawler.rendering.three.ThreeNode.colours = ["754C24","C7B299","F26C4F","3BB878","736357","605CA8","A67C52"];
js.Lib.onerror = null;
Main.main()